#pragma	title("ROP Viewer  --  Version 1  --  (AppDefs.C)")
...
HMQ  hmqROPs;			   /* Program Message Queue Handle	*/
HWND hwndROPs;			   /* Client Window Handle		*/
HWND hwndROPsFrame;		   /* Frame Window Handle		*/
HWND hmenuROPs;			   /* Menu Handle			*/
